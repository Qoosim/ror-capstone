...
RSpec.describe Category, type: :model do
  ...
  context 'Category Scope' do
    ...
    let(:article1) do
      subject.articles.create(title: 'Ruby', text: 'first content', image: '../image/splash7.jpg',
                              user_id: @user.id, created_at: '2020-07-17')
    end
    let(:article2) do
      subject.articles.create(title: 'Rails', text: 'second content', image: '../image/splash8.jpg',
